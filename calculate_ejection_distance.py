...
def __main(data: str, present_day_snap_number: str, cat_directory: str, cat_file_template: str):
    ...
    print_debug(f"Loading data from {catalogue_file_path_template.format(present_day_snap_number)}")
    ...
    print_verbose_info("Calculating particle displacement from last halo.")
    ...
    print_verbose_info("Box wrapping vectors.")
    ...
    # Calculate radii
    print_verbose_info("Calculating radii.")
